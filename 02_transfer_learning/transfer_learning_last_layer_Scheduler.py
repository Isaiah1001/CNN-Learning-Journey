...
from model import training_loop, count_parameters, save_checkpoint, load_checkpoint, build_efficientnet_b0, unfreeze_last_block_and_head
...
if __name__ == '__main__':
    ...
    unfreeze_last_block_and_head(base_model)
    ...
    # =========================
    finetune_checkpoint_path = os.path.join('checkpoints', 'efficientnet_b0_flower_lastlayer_plus_head_Scheduler.pth')
    save_checkpoint(
        trained_model,
        optimizer,
