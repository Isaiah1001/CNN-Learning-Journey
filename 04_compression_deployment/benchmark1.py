...
def log_to_mlflow(run_name, ckpt_path, size_stats, cpu_stats, mps_stats, batch_size, warmup, runs):
    ...
    with mlflow.start_run(run_name=run_name):
        ...
        print(f"View: python3 -m mlflow ui --backend-store-uri {TRACKING_URI} --port 5001\n")
...
# python benchmark.py --ckpt logs/checkpoints/checkpoint_base_xx_x.ckpt

# # batch latency (relevant for server throughput)
# python benchmark.py --ckpt logs/checkpoints/checkpoint_base_xx_x.ckpt --batch_size 32
